...
del "%DIRTARGET%\MvvmCross.dll"
del "%DIRTARGET%\MvvmCross.Platforms.Wpf.dll"
del "%DIRTARGET%\MvvmCross.Plugin.Control.dll"
del "%DIRTARGET%\MvvmCross.Plugin.Control.Platforms.Wpf.dll"
...
del "%DIRTARGET%\System.Drawing.Common.dll"

copy "%DIRCMD%\Cmd.exe" "%DIRTARGET%\Backend.exe"
...
copy "%DIRBROWSER%\MvvmCross.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\MvvmCross.Platforms.Wpf.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\MvvmCross.Plugin.Control.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\MvvmCross.Plugin.Control.Platforms.Wpf.dll" "%DIRTARGET%\"
...
copy "%DIRBROWSER%\System.Drawing.Common.dll" "%DIRTARGET%\"
