...
del "%DIRTARGET%\DevExpress.CodeParser.v22.2.dll"
del "%DIRTARGET%\DevExpress.Data.Desktop.v22.2.dll"
del "%DIRTARGET%\DevExpress.Data.v22.2.dll"
del "%DIRTARGET%\DevExpress.DataAccess.v22.2.dll"
del "%DIRTARGET%\DevExpress.Drawing.v22.2.dll"
del "%DIRTARGET%\DevExpress.Images.v22.2.dll"
del "%DIRTARGET%\DevExpress.Mvvm.v22.2.dll"
del "%DIRTARGET%\DevExpress.Map.v22.2.Core.dll"
del "%DIRTARGET%\DevExpress.Office.v22.2.Core.dll"
del "%DIRTARGET%\DevExpress.Pdf.v22.2.Core.dll"
del "%DIRTARGET%\DevExpress.Pdf.v22.2.Drawing.dll"
del "%DIRTARGET%\DevExpress.Printing.v22.2.Core.dll"
del "%DIRTARGET%\DevExpress.RichEdit.v22.2.Core.dll"
del "%DIRTARGET%\DevExpress.Xpf.Core.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Docking.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.DocumentViewer.v22.2.Core.dll"
del "%DIRTARGET%\DevExpress.Xpf.ExpressionEditor.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Grid.v22.2.Core.dll"
del "%DIRTARGET%\DevExpress.Xpf.Grid.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Grid.v22.2.Extensions.dll"
del "%DIRTARGET%\DevExpress.Xpf.Layout.v22.2.Core.dll"
del "%DIRTARGET%\DevExpress.Xpf.LayoutControl.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Map.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Office.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Printing.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Ribbon.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.RichEdit.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Themes.Office2019Colorful.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Themes.PeernetDarkTheme.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpf.Themes.PeernetLightTheme.v22.2.dll"
del "%DIRTARGET%\DevExpress.Xpo.v22.2.dll"
...
copy "%DIRBROWSER%\DevExpress.CodeParser.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Data.Desktop.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Data.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.DataAccess.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Drawing.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Images.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Mvvm.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Map.v22.2.Core.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Office.v22.2.Core.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Pdf.v22.2.Core.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Pdf.v22.2.Drawing.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Printing.v22.2.Core.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.RichEdit.v22.2.Core.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Core.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Docking.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.DocumentViewer.v22.2.Core.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.ExpressionEditor.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Grid.v22.2.Core.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Grid.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Grid.v22.2.Extensions.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Layout.v22.2.Core.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.LayoutControl.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Map.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Office.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Printing.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Ribbon.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.RichEdit.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Themes.Office2019Colorful.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Themes.PeernetDarkTheme.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpf.Themes.PeernetLightTheme.v22.2.dll" "%DIRTARGET%\"
copy "%DIRBROWSER%\DevExpress.Xpo.v22.2.dll" "%DIRTARGET%\"
